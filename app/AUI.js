...
ui.layout(
    <vertical padding="16">
        ...
        <text textSize="20sp" textColor="red" >4.抖音的版本为：V10.9.0 操作系统的版本为：安卓7.0+</text>
...
ui.btn1.click(()=>{
    ...
    if(faceva <= 0){
        ...
        faceValue = faceva;
        files.write("yanzhi.dat", faceValue);
    }
    ...
    if(pornva <= 0){
        ...
        pornValue = pornva;
        files.write("shuliang.dat", pornValue);
    }
