...
let parseContoursFilter = require("./base/parseContours");
...
let logger = new Logger({
  ...
  maxBackupSize: 3,
  dir: files.cwd() + "/data/scripts/paintOpencvContour/",
});

var paintOpencvContour = (function () {
  let q = {};
...
module.exports = paintOpencvContour;
